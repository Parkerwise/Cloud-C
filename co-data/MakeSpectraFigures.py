...
for i in range(number_of_windows):
    if i+1 != number_of_windows:
        ...
        ax1.plot(freq[channels_per_window*i:channels_per_window*(i+1)],spectrum[channels_per_window*i:channels_per_window*(i+1)],lw=1,drawstyle='steps-mid',color="SteelBlue")
        pylab.xlim(freq[channels_per_window*i].value,freq[channels_per_window*(i+1)].value)
        ...
        ax1.plot(freq_with_zeros,data_with_zeros.value,lw=1,drawstyle='steps-mid',color="SteelBlue")
